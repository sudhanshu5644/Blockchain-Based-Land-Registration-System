          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              return landWid(
                  ...
                  landInfo[index][8],
                  () => confirmDialog('Do you want to Sell', context, () async {
                        SmartDialog.showLoading();
                        if (connectedWithMetamask) {
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  onChanged: (val) {
                    landAddress = val;
                    addressController = val as TextEditingController;
                  },
                  style: const TextStyle(
                    fontSize: 15,
                  ),
                  ...
                  decoration: const InputDecoration(
                    ...
                    border: OutlineInputBorder(),
                    labelText: 'Address',
                    hintText: 'Enter Full Land Address with PIN Code',
                  ),
                ),
              ),
              Padding(
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Enter mail id or Phone no for communication',
                  ),
                ),
              ),
              Padding(
                ...
                child: MaterialButton(
                  ...
                  child: const Text('Mark Land on Map'),
                ),
              ),
              Padding(
                padding: const EdgeInsets.all(10),
                child: Row(
                  children: [
                    MaterialButton(
                      ...
                      child: const Text('Upload Land Document'),
                    ),
                    Text(docuName)
                  ],
                ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextFiled(userInfo[4].toString(), 'Aadhaar Number'),
