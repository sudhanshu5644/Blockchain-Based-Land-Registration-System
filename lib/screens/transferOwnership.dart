          ...
          return pw.Column(
              ...
              children: [
                ...
                pw.Table(columnWidths: {
                  ...
                  tableRow("1)Land Address: ", villegename),
                  tableRowSizedBox(),
                  tableRow("2)Land Price:", price),
                  tableRowSizedBox(),
                  tableRow("3)Area (Sq Ft):", area + " Sq ft"),
                  tableRowSizedBox(),
                  tableRow("4)Seller Name", sellername),
                  tableRowSizedBox(),
                  tableRow("5)Seller Address:", selleraddress),
                  tableRowSizedBox(),
                  tableRow("6)Seller PAN", sellerpan),
                  tableRowSizedBox(),
                  tableRow("7)Buyer Name", buyername),
                  tableRowSizedBox(),
                  tableRow("8)Buyer Address:", buyeraddress),
                  tableRowSizedBox(),
                  tableRow("9)Buyer PAN", buyerpan),
                  tableRowSizedBox(),
                  tableRow("10)Registration Date & Time:", date),
                  tableRowSizedBox(),
                  tableRow("11)Stamp Duty paid amount:", "Rs 6000"),
                  tableRowSizedBox(),
